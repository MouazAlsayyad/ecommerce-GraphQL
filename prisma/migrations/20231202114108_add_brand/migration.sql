...
CREATE TABLE "Product_Category" (
    ...
    CONSTRAINT "Product_Category_pkey" PRIMARY KEY ("brandId","productId")
);
...
-- AddForeignKey
ALTER TABLE "Product_Category" ADD CONSTRAINT "Product_Category_brandId_fkey" FOREIGN KEY ("brandId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
